...
def sign_in(meetingid,pswd):
    ...
    subprocess.call("C:\\Users\\acer\\AppData\\Roaming\\Zoom\\bin\\Zoom.exe")
    ...
    time.sleep(30) 
    #To select join with computer audio option
    join_comp = pyautogui.locateCenterOnScreen('join_comp_audio.png')
    pyautogui.moveTo(join_comp)
    pyautogui.click() 
    time.sleep(3)
    #To mute the audio
